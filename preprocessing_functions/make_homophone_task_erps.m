function ERPs = make_homophone_task_erps(evnt) %, exp_dat)
...
for i = 1:blocks
    for j = 1:ch_perblock
        ...
        %data = [data; mean(ecog_ch,1)]; % take the average of the 8 bands for the high gamma
        % NO LONGER NECESSARY TO MEAN, SINCE ALL DATA NOW DOWNSAMPLED...
        data = [data; ecog_ch];
    end
end
ecog.data = data;
